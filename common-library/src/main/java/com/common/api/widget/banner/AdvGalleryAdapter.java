...
//	private DisplayImageOptions mOptions;
	...
	public AdvGalleryAdapter(Context context, List<AdsEntity> data,
		...
		if(bannerDefaultPic!=null){
			...
			config.setLoadingDrawable(mContext.getResources().getDrawable(R.drawable.ic_loadding2));
			config.setLoadFailedDrawable(mContext.getResources().getDrawable(R.drawable.ic_loadding2));
		}
