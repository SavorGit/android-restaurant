...
//		mLoadingIv.setBackgroundResource(R.anim.loading);
...
//        mAnimationDrawable.start();
    ...
    public void loadEmpty(String firstTips, String secondTips, int failImgResId) {
        ...
        if (failImgResId == 0) {
            mErrorIv.setImageResource(R.drawable.xiaolian);
        } else {
        ...
        setStatusVisible(false, true, !TextUtils.isEmpty(firstTips), !TextUtils.isEmpty(secondTips));
    }
    ...
    public void loadFailure(String firstTips, String secondTips, int failImgResId) {
        ...
        firstTips = TextUtils.isEmpty(firstTips) ? mContext.getResources().getString(R.string.progressbar_failure) : firstTips;
        if (failImgResId == 0) {
            mErrorIv.setImageResource(R.drawable.xiaolian);
        } else {
            mErrorIv.setImageResource(failImgResId);
    ...
    private void setStatusVisible(boolean showLoadingRL, boolean showErrorIv, boolean showFirstTips, boolean showSecondTips) {
