...
//import com.savor.resturant.utils.ConstantsWhat;
...
// * @author savor
// */
//public class LocalVideoProAcitvity extends BasePlayActivity implements
...
//                    finish.setBackgroundResource(R.drawable.pro_selector);
//                    play_over = true;
//                    isPlaying = false;
//                    stopQuerySeek();
...
//    }
//
//    public static void startLocalVideoProActivity(Activity activity, VideoInfo videoInfo, boolean isPlaying,String projectId) {
...
//        mModelVideo = (VideoInfo) getIntent().getSerializableExtra("ModelVideo");
...
//            case R.id.to_back:
//                onBackPressed();
//                RecordUtils.onEvent(this,getString(R.string.video_to_screen_back_list));
//                break;
//            case R.id.tv_link:
...
////        LogUtils.d("startUpdateSeek");
////        sendQuerySeekMessage();
////    }
//
...
//                finish.setBackgroundResource(R.drawable.down_selector);
//                mProjecting = true;
//                isPlaying = true;
//                play_over = false;
//                setPlayButton(true);
...
//        //禁音
//        if (isMute) {
//            mute.setBackgroundResource(R.drawable.mute_off_selector);
//        }else {//非禁音
//            mute.setBackgroundResource(R.drawable.mute_on_selector);
//        }
//    }
//
//    @Override
