...
//    }
    ...
    public InputAlertDialog setInputHint(String hint) {
        showInput = true;
        if ("".equals(hint)) {
    ...
    public InputAlertDialog setPositiveButton(String text, final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("确定");
        } else {
    ...
    public InputAlertDialog setNegativeButton(String text, final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("取消");
        } else {
    ...
    public InputAlertDialog setMidButton(String text, final OnClickListener listener) {
        showMidBtn = true;
        if ("".equals(text)) {
            btn_mid.setText("取消");
        } else {
