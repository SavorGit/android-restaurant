...
public class RecommendServiceAdapter extends RecyclerView.Adapter<RecommendServiceAdapter.RecommendHolder> {
    ...
    public RecommendHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_recommend_service,parent,false);
    ...
    public void onBindViewHolder(final RecommendHolder holder, int position) {
        ...
        holder.ctl_parent.setTag(position);
        holder.ctl_parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int position = (int) holder.ctl_parent.getTag();

                boolean selected = mData.get(position).isSelected();
    ...
    public class RecommendHolder extends RecyclerView.ViewHolder {
        public ConstraintLayout ctl_parent;
        ...
        public RecommendHolder(View itemView) {
            ...
            ctl_parent = (ConstraintLayout) itemView.findViewById(R.id.ctl_parent);
