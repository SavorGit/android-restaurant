...
public class AliLogFileUtil {
     ...
     * @param filepath
     */
    public void writeLogToFile(final AliLogBean logBean, final String filepath) {
     ...
     * @param filepath
     */
    public void writeLogToFile(final AliLogBean logBean, final String filepath, final OnCompleteListener listener) {
        threadPool.execute(new Runnable() {
            @Override
            public void run() {
                File fileDir = new File(filepath);
